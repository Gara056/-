...
DOCS = [
    {
        "src": "TZ-racion-studio.md",
        "title": "ТЗ Racion Studio — автоматизация меню и КБЖУ",
        "banner": "Техническое задание · v0.9.1 · 8 сентября 2026",
    },
    {
        "src": "biznes-plan.md",
        "title": "Бизнес-план Racion Studio — бюджет и реализация",
        "banner": "Бизнес-план · v0.1 · 8 сентября 2026",
    },
]
