...
**Версия ТЗ:** 0.9 (черновик до ответов на уточняющие вопросы)  
...
| ИИ | любой LLM с JSON-схемой, отдельный сервис | легко сменить; не в ядре цифр |
...
*Документ v0.9. Не заменяет бриф разработки до ответов на вопросы раздела A.*
